...
export default function MemberOrderHistory() {
    ...
    const loadOrders = async () => {
        try {
            setLoading(true);
            const data = await ordersAPI.fetchAll(user.id);
            setOrders(data);
        } catch (err) {
    ...
    return (
        <div className="p-4">
            <div className="mb-6">
                <h1 className="text-3xl font-semibold text-gray-800">Riwayat Pesanan</h1>
                <p className="text-gray-400 mt-1">Daftar semua pesanan yang pernah Anda buat.</p>
            </div>
                    ...
                    <table className="w-full text-left">
                        <thead className="bg-gray-50 uppercase text-[10px] text-gray-400 font-bold">
                            <tr>
                                ...
                                <th className="p-4">Poin Didapat</th>
